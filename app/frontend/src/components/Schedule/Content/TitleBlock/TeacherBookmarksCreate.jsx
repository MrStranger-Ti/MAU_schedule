...
import TeacherBookmarksDisplay from "./TeacherBookmarksDisplay";

const TeacherBookmarksCreate = () => {
    return (
        <div className="schedule__title-left-block flex">
            <h1 className="schedule__title title">{{teacher_name}}</h1>
            <TeacherBookmarksDisplay/>
            <button className="btn schedule__bookmarks-btn" type="button"{% if has_bookamrk %} disabled{% endif %}>

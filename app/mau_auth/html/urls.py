...
urlpatterns = [
    ...
    path(
        ...
        RegistrationEmailSentView.as_view(),
        name="registration_email_sent",
    ),
    path(
        "registration/emailconfirm/<uidb64>/<token>/",
        RegistrationEmailConfirmView.as_view(),
        name="registration_email_confirm",
    ),
    ...
    path(
        "password_reset/done/",
        MauPasswordResetDoneView.as_view(),
        name="password_reset_done",
    ),
    path(
        "password_reset/<uidb64>/<token>/",
        MauPasswordConfirmView.as_view(),
        name="password_reset_confirm",
    ),
    path(
        "password_reset/complete/",
        MauPasswordCompleteView.as_view(),

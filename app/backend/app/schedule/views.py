...
from schedule.serializers import MauInstituteSerializer
            ...
            200: OpenApiResponse(
                ...
                examples=[
                    OpenApiExample(
                        ...
                        value=get_json(
                            settings.BASE_DIR
                            / "schedule/swagger_examples/group_schedule.json",
                        ),
                    ),
                ],
            ),
            ...
            200: OpenApiResponse(
                ...
                examples=[
                    OpenApiExample(
                        ...
                        value=get_json(
                            settings.BASE_DIR
                            / "schedule/swagger_examples/teachers_keys.json",
                        ),
                    ),
                ],
            ),
            ...
            200: OpenApiResponse(
                ...
                examples=[
                    OpenApiExample(
                        ...
                        value=get_json(
                            settings.BASE_DIR
                            / "schedule/swagger_examples/teacher_schedule.json",
                        ),
                    ),
                ],
            ),
            ...
            200: OpenApiResponse(
                ...
                examples=[
                    OpenApiExample(
                        ...
                        value=get_json(
                            settings.BASE_DIR
                            / "schedule/swagger_examples/periods.json",
                        ),
                    ),
                ],
            ),
